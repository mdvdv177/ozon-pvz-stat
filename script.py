...
def process_inventory_file(file_path):
    ...
    df.to_csv('/Users/snaker177/Documents/склад/result.csv', index=False, encoding='utf-8')
    
    with open('/Users/snaker177/Documents/склад/result.csv', 'r', encoding='utf-8-sig') as f:
